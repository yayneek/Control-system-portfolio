...
class Metaclass_GripperControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorial_interfaces.srv.GripperControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorial_interfaces.srv import _gripper_control
...
class GripperControl(metaclass=Metaclass_GripperControl):
    from tutorial_interfaces.srv._gripper_control import GripperControl_Request as Request
    from tutorial_interfaces.srv._gripper_control import GripperControl_Response as Response

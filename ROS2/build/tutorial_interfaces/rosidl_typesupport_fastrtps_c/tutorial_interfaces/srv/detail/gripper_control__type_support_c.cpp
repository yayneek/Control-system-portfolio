...
#include "tutorial_interfaces/srv/detail/gripper_control__rosidl_typesupport_fastrtps_c.h"
...
using _GripperControl_Request__ros_msg_type = tutorial_interfaces__srv__GripperControl_Request;
...
size_t get_serialized_size_tutorial_interfaces__srv__GripperControl_Request(
  const void * untyped_ros_message,
...
static uint32_t _GripperControl_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__srv__GripperControl_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__srv__GripperControl_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces__srv__GripperControl_Request;
    is_plain =
      (
...
static size_t _GripperControl_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__srv__GripperControl_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, srv, GripperControl_Request)() {
...
using _GripperControl_Response__ros_msg_type = tutorial_interfaces__srv__GripperControl_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t get_serialized_size_tutorial_interfaces__srv__GripperControl_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperControl_Response__ros_msg_type * ros_message = static_cast<const _GripperControl_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__srv__GripperControl_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__srv__GripperControl_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tutorial_interfaces__srv__GripperControl_Response;
    is_plain =
      (
...
static size_t _GripperControl_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__srv__GripperControl_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, srv, GripperControl_Response)() {
...
// already included above
// #include "tutorial_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "tutorial_interfaces/srv/gripper_control.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, srv, GripperControl)() {

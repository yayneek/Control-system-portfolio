...
#ifndef TUTORIAL_INTERFACES__SRV__DETAIL__GRIPPER_CONTROL__FUNCTIONS_H_
#define TUTORIAL_INTERFACES__SRV__DETAIL__GRIPPER_CONTROL__FUNCTIONS_H_
 ...
 * calls
 * tutorial_interfaces__srv__GripperControl_Request__init().
...
/**
 * It calls
 * tutorial_interfaces__srv__GripperControl_Request__fini()
 ...
 * tutorial_interfaces__srv__GripperControl_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tutorial_interfaces__srv__GripperControl_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tutorial_interfaces__srv__GripperControl_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tutorial_interfaces
...
/**
 * It calls
 * tutorial_interfaces__srv__GripperControl_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tutorial_interfaces
...
/**
 * It allocates the memory for the array and calls
 * tutorial_interfaces__srv__GripperControl_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tutorial_interfaces
...
/**
 * It calls
 * tutorial_interfaces__srv__GripperControl_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TUTORIAL_INTERFACES__SRV__DETAIL__GRIPPER_CONTROL__FUNCTIONS_H_
